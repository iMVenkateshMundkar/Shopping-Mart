...
export const USER_LOGOUT_SUCCESS = "USER__SUCCESSLOGOUT";
export const USER_LOGOUT_FAILURE = "USER__FAILURELOGOUT";
...
export const USER_PROFILE_DETAILS_FAILURE = "USER_PROFILE_DETAILS_FAILURE";
